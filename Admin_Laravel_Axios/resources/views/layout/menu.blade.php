    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        <div class="navbar-collapse">
            <ul class="navbar-nav mr-auto mt-md-0">
             ...
             <li class="nav-item mt-3">ADMIN Panel</li>
            </ul>
    ...
    <div class="scroll-sidebar">
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a href="{{ url('/course') }}" ><span> <i class="fa fa-book-open"></i> </span><span class="hide-menu">Course</span></a></li>
                <li> <a href="{{ url('/project') }}" ><span> <i class="fa fa-code"></i> </span><span class="hide-menu">Project</span></a></li>
                <li> <a href="{{ url('/photo') }}" ><span> <i class="fa fa-image"></i> </span><span class="hide-menu">Photo</span></a></li>
                <li> <a href="{{ url('/contact') }}" ><span> <i class="fa fa-phone"></i> </span><span class="hide-menu">Contact</span></a></li>
                <li> <a href="{{ url('/review') }}" ><span> <i class="fa fa-comments"></i> </span><span class="hide-menu">Review</span></a></li>
