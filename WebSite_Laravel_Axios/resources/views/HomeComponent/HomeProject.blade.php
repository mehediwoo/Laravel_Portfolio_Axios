            ...
            <div id="one"  class="owl-carousel mb-4 owl-theme">
                ...
                <div class="item m-1 card">
                    <div class="text-center">
                        <img class="w-100" src="{{$project->ProjectImage}}" alt="Card image cap">
                        <h5 class="service-card-title mt-4">{{$project->ProjectName}}</h5>
                        <h6 class="service-card-subTitle p-0 m-0">{{$project->ProjectDesc}} </h6>
                        <a href="{{$project->ProjectLink}}" target ="_blank" class="normal-btn-outline mt-2 mb-4 btn">বিস্তারিত</a>
                    </div>
                </div>
                @endforeach
            </div>
